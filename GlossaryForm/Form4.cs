...
namespace GlossaryForm
{
    public partial class AddWordForm : Form
    {
        ...
        public AddWordForm()
        {
            ...
            switch (ManageForm.wordlist.Languages.Count())
            {
                case 2: 
                    lbl_Language1.Text = ManageForm.wordlist.Languages[0];
                    lbl_Language1.Text = ManageForm.wordlist.Languages[1];
                    break;

                case 3:
                    lbl_Language1.Text = ManageForm.wordlist.Languages[0];
                    lbl_Language2.Text = ManageForm.wordlist.Languages[1]; 
                    lbl_Language3.Text = ManageForm.wordlist.Languages[2];
                ...
                case 4:
                    ...
                    lbl_Language2.Text = ManageForm.wordlist.Languages[1];
                    lbl_Language3.Text = ManageForm.wordlist.Languages[2];
                    lbl_Language4.Text = ManageForm.wordlist.Languages[3];
                    txtBox_Language3.Enabled = true;
                ...
                case 5:
                    ...
                    lbl_Language3.Text = ManageForm.wordlist.Languages[2];
                    lbl_Language4.Text = ManageForm.wordlist.Languages[3];
                    lbl_Language5.Text = ManageForm.wordlist.Languages[4];
                    txtBox_Language3.Enabled = true;
                    txtBox_Language4.Enabled = true;
        ...
        {
            string[] words = new string[ManageForm.wordlist.Languages.Length];
            int index = 0;
            ...
            foreach (TextBox tb in this.Controls.OfType<TextBox>().Reverse())
            {
                ...
                else if (tb.Enabled && tb.Text == "")
                {
                    ...
                    ManageForm.RefreshList();
                    return;
                }
            }

            ManageForm.wordlist.Add(words);
